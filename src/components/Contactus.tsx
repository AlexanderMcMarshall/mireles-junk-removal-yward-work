...
const ContactQuoteForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:jmmireles8911@gmail.com?subject=${subject}&body=${body}`;
  };
        ...
        <div className="grid gap-8 md:grid-cols-2 items-start max-w-5xl mx-auto">
          <div className="bg-card rounded-2xl p-6 shadow-md">
            ...
            <div className="space-y-3 text-sm text-foreground">
              <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-accent" /> 707-599-5377</div>
              <div className="flex items-center gap-2"><Mail className="w-4 h-4 text-accent" /> jmmireles8911@gmail.com</div>
